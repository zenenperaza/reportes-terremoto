...
<label>Nombre (Alias)<input type="text" name="nombre_alias" value="{{ old('nombre_alias',$proyecto?->nombre_alias) }}" maxlength="255" placeholder="Nombre corto del proyecto"></label>
