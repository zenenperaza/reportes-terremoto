...
class ReportWorkflowTest extends TestCase
{
    ...
    public function test_reports_and_beneficiary_summary_are_scoped_to_the_user_except_for_administrators(): void
    {
        ...
        $this->actingAs($owner)->get('/informe-beneficiarios')
            ...
            ->assertSee('Niñas de 6 a 9 años')
            ->assertSee('Niñas de 10 a 11 años')
            ->assertSee('Niñas de 12 a 14 años')
            ->assertSee('Niñas de 15 a 17 años')
            ->assertSee('Mujeres de 18 a 19 años')
            ->assertSee('Mujeres de 20 a 49 años')
            ->assertSee('Mujeres de 50 a 59 años')
            ->assertSee('Total NNA')
            ->assertSee('Total de adultos')
            ->assertSee('summary-subtotal', false)
    ...
    public function test_each_beneficiary_is_saved_immediately_under_the_same_report_header(): void
    {
        ...
        $this->assertDatabaseHas('beneficiaries', ['report_id' => $reportId, 'full_name' => null, 'age' => 34]);
